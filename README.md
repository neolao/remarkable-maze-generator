...
- The web configuration form remembers your last-used settings (width, height, difficulty, maze type, algorithm, solution mode, the solution preview checkbox, and the reMarkable target folder) and pre-fills them automatically on your next visit
<!-- vibe:end:features -->
