...
- Choose a difficulty level to control how many branch points and decision points the maze has; for the classic and bridge-crossing rectangle types, higher difficulty also makes wrong turns run longer before dead-ending
