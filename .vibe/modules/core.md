...
**Exports:** `CORE_VERSION: string`, `generateMaze(options: GenerateMazeOptions): Maze`, `solveMaze(maze: Maze): MazePosition[]`, `renderMazeToPdf(maze: Maze): Promise<Uint8Array>`, `REMARKABLE_2_PAGE_WIDTH_PT`, `REMARKABLE_2_PAGE_HEIGHT_PT`, types `Maze`, `Cell`, `CellWalls`, `GenerateMazeOptions`, `MazePosition`
